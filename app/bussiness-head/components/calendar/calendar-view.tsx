...
export function CalendarView() {
  ...
  const addEvent = (event: Omit<CalendarEvent, "id"> | Partial<CalendarEvent>) => {
    ...
    if (
      ...
      // You may want to show an error or handle this case
      return
    }
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
      {/* Calendar Header */}
      <div className="bg-[#E8FF8A] px-6 py-4 border-b border-gray-200">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-1">
              <Button
                ...
                className={view === "month" ? "bg-[#D3FF61] text-black" : ""}
              >
                Month
              </Button>
              <Button
                ...
                className={view === "week" ? "bg-[#D3FF61] text-black" : ""}
              >
                Week
              </Button>
            </div>
            <Button onClick={() => setShowEventForm(true)} className="bg-[#D3FF61] text-black hover:bg-[#C5FF4A]">
          ...
          {getDaysInMonth(currentDate).map((date, index) => {
            ...
            return (
              ...
              >
                {date && (
                  <>
                    <div className={`text-sm font-medium mb-2 ${isToday ? "text-black" : "text-gray-700"}`}>
                      {date.getDate()}
                    </div>
      ...
      {showEventForm && (
        <EventForm
          ...
          onSave={selectedEvent ? (updates) => updateEvent(selectedEvent.id, updates) : addEvent}
