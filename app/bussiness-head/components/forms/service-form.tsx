...
import { useCRM, type Service } from "../crm-provider"
...
export function ServiceForm({ service, onClose }: ServiceFormProps) {
  ...
  const categories = ["Consulting", "Development", "Design", "Marketing", "Support", "Training", "Maintenance", "Other"]

  const durations = ["1 week", "2 weeks", "1 month", "2 months", "3 months", "6 months", "1 year", "Ongoing"]

  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold text-black">{service ? "Edit Service" : "Add New Service"}</h2>
