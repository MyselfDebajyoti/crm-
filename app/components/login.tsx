        ...
        {!showLoginForm ? (
          ...
          <div className="min-h-screen bg-white flex flex-col">
            ...
            <div className="flex justify-center pt-3 pb-0">
              <Image
                src="/Frame 109-cropped.svg" // Replace with your actual logo path
                alt="Finployee"
                width={150}
                height={40}
                className="h-10 w-auto object-contain"
            ...
            {/* Main Content Container */}
            <div className="flex-1 flex flex-col  px-6 pb-2 ">
              {/* Hero Section */}
              <div className=" flex flex-2  items-center justify-center ">
                <div className="w-full max-w-sm  ">
                  {/* Mobile Welcome Image */}
                  <div className="relative w-full aspect-[4/5]  h-95 md:h-100 md:w-full mb-2">
                    <Image
                      src="/Frame 50.png" // Replace with your actual image path
                      alt="Financial clarity, minus the mess"
                      fill
                  ...
                  <div className=" mt-4 flex justify-end">
                    <Button
                      onClick={handleContinue}
                      className=" w-[40%] bg-[#A9CC4E] hover:bg-[#98b844] text-black py-4 px-6 rounded-xl font-medium text-lg font-helvetica shadow-lg"
                    >
                      Continue
                    </Button>
                  </div>
