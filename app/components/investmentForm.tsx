...
import { useCRM, type Investment } from "../debajyoti/tasks/crmProvider";
...
export function InvestmentForm({ investment, onClose }: InvestmentFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const returnPercentage =
      formData.amount > 0 ? (returns / formData.amount) * 100 : 0;
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <span
                    className={`ml-2 font-medium ${
                      formData.currentValue - formData.amount >= 0
                        ? "text-green-600"
                        : "text-red-600"
                    }`}
                  >
                ...
                <div>
                  ...
                  <span
                    className={`ml-2 font-medium ${
                      ((formData.currentValue - formData.amount) /
                        formData.amount) *
                        100 >=
                      0
                        ? "text-green-600"
